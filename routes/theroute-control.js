...
// // Get comments filter by user id: for validation
// getCommentsToValidate = (req, res) => {
//   console.log(`The id params: ${req.body}`);
//   console.log(req.body);

//   aComment
//     .find()
//     .then(couponsReviews => res.status(200).send(couponsReviews))
//     .catch(err => res.status(400).send(err));
// };
